...
const routes = [
  ...
  {
    path: '/cuenta/venta/:id',name:'venta',component: ()=> import('@/views/ventas/VentaDetalleApp.vue'),
  },
  {
    path: '/cuenta/venta',name:'venta-index',component: ()=> import('@/views/ventas/VentaIndexApp.vue'),
  },
