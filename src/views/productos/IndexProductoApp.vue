        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row" id="my-table">
                    ...
                    <RouterLink :to="{name: 'show-producto',params:{slug : item.slug}}">
                        <div class="product">
                ...
                <div class="sidebar col-xl-3 col-lg-4 order-lg-1">
                    ...
                    <div class="sidebar-block px-3 px-lg-0 me-lg-4"> <a class="d-lg-none block-toggler" data-bs-toggle="collapse" href="#sizeFilterMenu" aria-expanded="false" aria-controls="sizeFilterMenu">Filtro por Talla</a>
                        <!-- Size filter menu-->
                        ...
                        <form class="mt-4 mt-lg-0" action="#">  
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size0" type="radio" value="X-Large" name="size" v-on:change="selectedSizes($event)">
                                <label class="form-check-label" for="size0">Small</label>
                            </div>
                            </div>
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size1" type="radio" value="X-Large" name="size" v-on:change="selectedSizes($event)">
                                <label class="form-check-label" for="size1">Medium</label>
                            </div>
                            </div>
                            <div class="mb-1">
                            <div class="form-check">
                                <input class="form-check-input" id="size2" type="radio" value="X-Large" name="size" v-on:change="selectedSizes($event)">
...
import { RouterLink } from 'vue-router';
    ...
    methods: {
        ...
        selectedSizes(event) {
            this.productos = this.productos_const.filter(item => item.variedades.some(subitem => subitem.variedad.toLowerCase() == event.target.value.toLowerCase()));
        }
    },
    watch: {
        $route(to, from) {
