        ...
        <div class="row">
              ...
              <div class="col-12 col-md-10 detail-carousel">
                ...
                <div class="owl-carousel detail-slider owl-theme owl-dots-modern" data-slider-id="1">
                  <div class="item" v-if="galeria[0]">
                    <a class="glightbox" :href="$url+'/obtener_galeria_producto/'+galeria[0].imagen" data-title="" data-gallery="producto-gallery">
          ...
          <div class="col-lg-5 ps-lg-4 order-1 order-lg-2">
            <ul class="breadcrumb undefined">
              ...
              <li class="breadcrumb-item"><router-link :to="{ name: 'shop', query: { categoria: producto.categoria } }">{{
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-12 detail-option mb-3">
                ...
                <label class="btn btn-sm btn-outline-secondary detail-option-btn-label" :id="'variedad_' + item._id"
                  :for="'variedad_' + item._id" v-for="item in variedades" v-on:click="getVariedad(item._id)">
                  {{ item.variedad }}
                ...
                <table class="table text-sm">
                  <tbody>
                    <tr>
                      ...
                      <td class="text-muted border-0" v-if="producto.titulo" :title="producto.titulo">
