<template>
  <header class="header header-absolute">
      ...
      <!-- Top Bar End-->
      <!-- Navbar-->
      <nav class="navbar navbar-expand-lg navbar-sticky navbar-airy navbar-dark bg-fixed-white navbar-fixed-light" style="background: #D3A5A5 !important;">
        <div class="container-fluid">  
          <!-- Navbar Header  -->
...
<a class="navbar-brand" href="./index.html">
   <img src="/assets/img/logo_liveralia.png" class="navbar-brand-img mx-auto" alt="..." width="100" height="100">
</a>
